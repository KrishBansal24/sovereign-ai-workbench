"""Safe local storage and deterministic extraction for Phase 2 documents."""
...
class DocumentService:
    """File-based Phase 2 store; JSON metadata keeps the design lightweight and replaceable."""

    def __init__(self, data_directory: Path | None = None, max_upload_size_mb: int | None = None):
