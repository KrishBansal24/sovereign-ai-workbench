...
| 2 — Document Ingestion & Processing | **Next** | Local PDF/TXT/DOCX storage and deterministic extraction | Phase 1 |
| 3 — Multi-Model Support & Router | Planned | Model management and task-aware routing | Phases 1–2 |
